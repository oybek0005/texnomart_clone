                        ...
                        children: [
                          Center(
                            child: CarouselSlider(
                              ...
                              items: detail?.largeImages?.map((image) {
                                return Padding(
                          ...
                          SizedBox(height: 30),
                          customText(
                              detail?.name ?? "Mavjud emas", FontWeight.w600, 20),
                          SizedBox(
                            height: 16,
                          ),
                          Container(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: customText(
                                          "Savatga qoshish", FontWeight.w600, 20),
                                    ),
                                  ),
                                ),
                                Padding(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                customText("Kafolat 1 yil", FontWeight.w500, 18),
                                Spacer()
                              ],
                            ),
                          ),
                          decreption != null
                            ...
                            children: [
                              ...
                              customText("Tavsif", FontWeight.w700, 22),
                              SizedBox(
                                height: 8,
                              ),
                              customTextXit(removeHtmlTags(decreption),
                                  FontWeight.w400, 16, 4),
                              SizedBox(
                                height: 8,
                              ),
                              GestureDetector(
                                  ...
                                  child: customText(
                                      "Ko'proq o'qish", FontWeight.w400, 16,
                          ...
                          ((feature?.first.characters?.length??0)>=4)
                            ...
                            itemCount: (feature?.first.characters?.length??0)>=4?feature?.first.characters?.length??0:4,
                            itemBuilder: (context, index) {
                              final data = feature?.first.characters?[index];
                              return Padding(
                                padding:
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Spacer(),
                                    Expanded(
                                      child: customTextXit(data?.value ?? "",
                                          FontWeight.w400, 16, 1,
                                          align: TextAlign.end),
                                    ),
                                  ],
                                ),
                          ...
                          GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => OtherDataScreen(
                                            feature: state.feature,
                                            title: "Xususiyatlar")));
                              },
                              child: customText(
                                  "Barcha xususiyatlar", FontWeight.w400, 16,
                                  color: Colors.blueAccent)),
                          SizedBox(height: 16),
                          GestureDetector(
                              onTap: () {},
